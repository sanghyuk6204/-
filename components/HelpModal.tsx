        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in">
            <div ref={modalRef} className="bg-slate-900 border border-slate-700 rounded-lg shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col">
                <header className="p-4 flex justify-between items-center border-b border-slate-700 shrink-0">
                    <h2 className="text-xl font-bold text-cyan-400">날로먹자 키워드 for Gemini: 상세 매뉴얼</h2>
                ...
                <main className="p-6 overflow-y-auto space-y-8 text-slate-300">
                    <section>
                        ...
                        <p className="text-sm leading-relaxed">
                            <strong>'날로먹자 키워드 for Gemini'</strong>는 최신 Gemini AI 모델을 기반으로 한 올인원 SEO 및 콘텐츠 전략 도구입니다. 블로거, 마케터, 콘텐츠 크리에이터를 위해 설계되었으며, 단순한 키워드 검색을 넘어 데이터 기반의 실행 가능한 전략을 제공하는 것을 목표로 합니다. Google과 Naver의 데이터를 활용하여 사용자가 경쟁에서 앞서나갈 수 있도록 돕습니다.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-sm leading-relaxed bg-slate-800/50 p-2 rounded-md"><strong>✨ 활용팁:</strong> 목록의 키워드를 클릭하면 해당 키워드로 즉시 새로운 분석을 시작할 수 있습니다. 하단의 '주제 만들기' 버튼을 통해 즉시 블로그 아이디어를 얻어보세요.</p>
                            </div>
                             <div>
                            ...
                            <div>
                                ...
                                <p className="text-sm leading-relaxed mb-2"><strong>프롬프트 라이브러리:</strong> 우측 사이드바의 '날로먹자 키워드 프롬프트 50' 버튼을 누르면, 전문가용으로 설계된 50가지 SEO 분석 프롬프트를 즉시 실행할 수 있습니다.</p>
